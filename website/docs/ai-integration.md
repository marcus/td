...
The `commit-msg` hook rewrites only the first line to `feat|fix|chore: <summary> (td-<id>)`, leaves bodies and trailers untouched, and preserves Git-generated merge/autosquash subjects.
