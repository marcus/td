...
func TestDeleteAlreadyDeletedIssue(t *testing.T) {
	...
	// Delete once
	mustDeleteIssue(t, database, issue.ID)
...
func TestDeleteWithDependencies(t *testing.T) {
	...
	// Add dependency
	mustAddDependency(t, database, child.ID, parent.ID, "depends_on")
...
func TestDeletePreservesIssueData(t *testing.T) {
	...
	// Delete the issue
	mustDeleteIssue(t, database, issueID)
