...
func TestHandoffRecordsGitSnapshot(t *testing.T) {
	...
	database.AddHandoff(handoff) //nolint:errcheck // test setup
...
func TestMultipleHandoffsForSameIssue(t *testing.T) {
	...
	database.AddHandoff(handoff1) //nolint:errcheck // test setup
	...
	database.AddHandoff(handoff2) //nolint:errcheck // test setup
...
func TestHandoffNoteFlag(t *testing.T) {
	...
	// Reset
	handoffCmd.Flags().Set("note", "") //nolint:errcheck // test setup
}
...
func TestGetLatestHandoff(t *testing.T) {
	...
	// Add handoffs
	database.AddHandoff(&models.Handoff{ //nolint:errcheck // test setup
		IssueID:   issue.ID,
		SessionID: "ses_old",
...
func TestHandoffMessageFlag(t *testing.T) {
	...
	// Reset
	handoffCmd.Flags().Set("message", "") //nolint:errcheck // test setup
}
