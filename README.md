...
The `commit-msg` hook normalizes only the first line to `<type>: <summary> (td-<id>)`, leaves commit bodies and trailers untouched, and preserves Git-generated merge/autosquash subjects.
