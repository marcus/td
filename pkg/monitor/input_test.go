...
func TestHandleMouseMsg_WheelScroll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			msg := tea.MouseWheelMsg{X: 50, Y: 15, Button: tt.button}
...
func TestHandleMouseMsg_ClickOffscreen(t *testing.T) {
	...
	msg := tea.MouseClickMsg{X: 200, Y: 200, Button: tea.MouseLeft}
...
func TestMouseClickWithScrolling(t *testing.T) {
	...
	msg := tea.MouseClickMsg{X: 50, Y: 15, Button: tea.MouseLeft}
